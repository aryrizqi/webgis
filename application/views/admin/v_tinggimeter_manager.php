...
<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-md-6">
						<h1 class="page-title">Tinggi Meter Manager</h1>
					</div>
...
<div class="ibox float-e-margins border-green-top table-list-siswa">
            ...
            <?php $no = 1; 
				...
				<div class="btn-group">
								...
								<li>
			                    <a href="<?php echo site_url('admin/form_tinggimeter?id=').$row->id ?>" role="button" class="" data-html="true" data-target="" data-toggle="modal"> EDIT</a>
			                    </li>
			                    <li>
                ...
                <td><?php echo $row->tinggi_meter; ?></td>
                            ...
                            <div class="modal-dialog">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title"><i class="ti-settings"></i> Hapus Tinggi Meter Manager</h4>
                                </div>
                                <form method="POST" action="<?php echo site_url('admin/delete_form_tinggimeter?id='.$row->id) ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label>KODE TINGGI METER:</label>
                                      <div>
                                        <input type="text" class="form-control" value="<?php echo $row->kd_tinggi; ?>" name="kd_tinggi" readonly>
                                      </div>
                                    </div>

					...
					<ul>
						<li>
					            ...
					            <?php 
					                ...
					                <td><a class="btn btn-primary btn-xs" href="<?php echo site_url('data/detailTinggiMeter?kd='.$row->kd_kota.'&tanggal='.$_GET['tanggal'].'&bulan='.$_GET['bulan'].'&jam='.$i);?>" role="button">DETAIL</a></td>
					            </tr> 
					            <?php } } } else { ?>
					            <tr class="gradeX">

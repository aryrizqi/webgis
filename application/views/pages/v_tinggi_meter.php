	...
	<div class="services">
		...
		<?php
			...
			<div style="color: black">
				...
				<label class="col-sm-8 control-label">: <?php echo $_GET['tanggal'];?></label>
				<label class="col-sm-4 control-label"><i>(Date)</i></label>
                </div>

                <div class="form-group col-sm-12">
                <label class="col-sm-4 control-label">Jam</label>
				<label class="col-sm-8 control-label">: <?php echo $_GET['jam'];?></label>
				<label class="col-sm-4 control-label"><i>(Hour)</i></label>
                </div>
				...
				<div class="media">
					<ul>
						<li>
					            ...
					            <tr class="gradeX">
					            <?php 
					            		if(isset($tinggi_meter)) {
					                      foreach ($tinggi_meter->result() as $row) {
					                        	# code...
					                        
					                      ?>
					                <td><h5>
					                <?php 
					                if($row->tinggi_meter != null) {
					                echo $row->tinggi_meter;
